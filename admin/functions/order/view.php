...
echo '<h5>&nbsp;&nbsp;Total: '.$ps.''.$tot.'</h5>';
      ...
      echo '<h4 style="color : green;">User Used Coupon code!</h4>';
   }
}
?>
...
while($row3 = mysqli_fetch_assoc($user)){
                        ?>
                        <h4>Phone No: <?php echo $row3['phno']; ?></h4>
                        <h4>City: <?php echo $row3['city']; ?></h4>
                        <h4>Street Address: <?php echo $row3['stadd']; ?></h4>
                        <h4>Pincode: <?php echo $row3['pincode']; ?></h4>
                        <?php } ?>
                  </div>
                           </div>
                           </div>
