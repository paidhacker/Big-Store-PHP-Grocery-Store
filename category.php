...
$id = $_GET['catid'];
$category1 = mysqli_query($conn, "SELECT * FROM `categories` where id='$id' and status='1'");
if(empty($id)){
	echo '<meta HTTP-EQUIV="REFRESH" content="0; url=index.php">';
}
else{
if(mysqli_num_rows($category1) < 1){
	echo '<meta HTTP-EQUIV="REFRESH" content="0; url=index.php">';
}
}
$product = mysqli_query($conn, "SELECT * FROM `product` where category='$id' and quantity > 0");
...
while($row = mysqli_fetch_assoc($category1)){
	...
	<?php } ?>
			...
			<div class=" con-w3l">
					<?php
					$check1 = mysqli_num_rows($product);
					if($check1>0){
while($best_pro = mysqli_fetch_assoc($product)){
					?>
